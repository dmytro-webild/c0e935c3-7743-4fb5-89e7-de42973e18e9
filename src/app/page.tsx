    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroBillboardCarousel
          ...
          buttons={[
            { text: "Get Started", href: "https://calendly.com/ibbiyousuf420/30min" },
      ...
      <div id="about" data-section="about">
        <InlineImageSplitTextAbout
          ...
          buttons={[
            { text: "Learn More", href: "https://calendly.com/ibbiyousuf420/30min" },
      ...
      <div id="features" data-section="features">
        <FeatureCardTwentyFive
          ...
          useInvertedBackground={false}
          buttons={[
            { text: "View Our Work", href: "https://calendly.com/ibbiyousuf420/30min" },
          ]}
        />
      </div>
          ...
          plans={[
            {
              id: "1",              price: "$499",              name: "Starter",              buttons: [
                { text: "Get Started", href: "https://calendly.com/ibbiyousuf420/30min" },
                { text: "Chat to Sales", href: "https://calendly.com/ibbiyousuf420/30min" },
              ],
              features: [
