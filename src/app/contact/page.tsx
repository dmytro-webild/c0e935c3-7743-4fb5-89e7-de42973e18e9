        ...
        <div className="flex flex-col items-center justify-center">
          <div className="w-full max-w-2xl rounded-theme bg-card p-10">
            ...
            <p className="mt-8 text-center text-sm text-foreground/75">
              Or <a href="https://calendly.com/ibbiyousuf420/30min" target="_blank" rel="noopener noreferrer" className="underline text-primary-cta">schedule a call directly</a>
            </p>
          </div>
        </div>
      </div>
